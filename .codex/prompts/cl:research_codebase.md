---
description: "Claude command: research_codebase"
---

<!-- Migrated from .claude/commands/cl/research_codebase.md. Use /prompts:cl:research_codebase (or type /cl:research_codebase and select it in slash popup). -->
